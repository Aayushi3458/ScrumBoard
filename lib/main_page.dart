...
class _MyAppState extends State<MainPage> {
            ...
            list.add(
              PopupMenuItem(
                ...
                child: FlatButton(
                    ...
                    onPressed: () { if(Variables.currentEmail==Variables.projectCreatedBy) {
                      removeCollaborator(
  ...
  var C;
  Future<String> removeCollaborator(BuildContext context,var collaboratorName) {
    return showDialog(
        context: context,
        builder: (context) {
          return AlertDialog(
            ...
            actions: <Widget>[
              MaterialButton(
                ...
                onPressed: () async {
                   Navigator.of(context).pop();
                    await _collab.collection("project")
                        .where(
                        "project_id", isEqualTo: Variables.currentProjectId)
                        .snapshots()
                        .listen((data) =>
        ...
        appBar: AppBar(
          ...
          actions: <Widget>[
            IconButton(
              ...
              onPressed: () => showProjectCode(context),
            ),
            collaborators(),
